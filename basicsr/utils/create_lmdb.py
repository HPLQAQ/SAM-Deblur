...
def create_lmdb_for_reloblur(stage: str):
    folder_path = f'./datasets/ReLoBlur-ori/{stage}/target'
    lmdb_path = f'./datasets/ReLoBlur-ori/{stage}/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = f'./datasets/ReLoBlur-ori/{stage}/input'
    lmdb_path = f'./datasets/ReLoBlur-ori/{stage}/input.lmdb'
